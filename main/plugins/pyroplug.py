...
MONGODB_CONNECTION_STRING = "mongodb+srv://v:v@cluster0.nxixaul.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" #edit this
OWNER_ID = 1258310642 # edit this
LOG_GROUP = -1002075422559 #edit this
        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg', 'ts', 'avi', 'flv', 'org']:
                ...
                caption = f"{msg.caption}\n\n__Unrestricted by **[Team SPY](https://t.me/dev_gagan)**__" if msg.caption else "{msg.caption}\n\n__Unrestricted by **[Team SPY](https://t.me/dev_gagan)**__"
